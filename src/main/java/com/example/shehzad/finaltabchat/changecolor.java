...
public class changecolor extends Dialog implements SeekBar.OnSeekBarChangeListener {
     ...
     */
    public changecolor(Activity a, int r, int g, int b) {
        super(a);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
       ...
       // colorView.setBackgroundColor(Color.rgb(red, green, blue));
        MainActivity.getInstance().toolbar.setBackgroundColor(Color.rgb(red, green, blue));
        MainActivity.getInstance().tabLayout.setBackgroundColor(Color.rgb(red, green, blue));
        if(red>25 && blue>25 && green>25){
        MainActivity.getInstance().window.setStatusBarColor(Color.rgb(red-25, green-25, blue-25));}
        else{MainActivity.getInstance().tabLayout.setBackgroundColor(Color.rgb(red, green, blue));}
